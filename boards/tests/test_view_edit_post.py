...
class PostUpdateViewTestCase(TestCase):
	"""
	Base test case to be used in all other test case here 
	"""
	def setUp(self):
...
class UnauthorizedPostUpdateViewTests(PostUpdateViewTestCase):
	def setUp(self):
		"""
			Create a user differennt from the one who posted
		"""
		super().setUp()
		username = 'jane'
		password = '321'
	...
	def test_status_code(self):
		"""
		unauthorized user editing other user's post will get 404 respond
		"""
